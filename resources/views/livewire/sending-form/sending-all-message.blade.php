                ...
                <div class="card-body">
                    ...
                    @foreach (App\Models\Submission::category(1, 'id_user_pengirim') as $data)
                        <div class="card mb-3 mt-2 shadow-md">
                            ...
                            <div class="m-3">
                                {{-- cek berdarkan extension --}}
                                <img src="https://www.svgrepo.com/show/144578/pdf.svg" width="5%" height="5%"
                                    alt="" srcset="">
                                <a href="{{ __($data->file_name) }}" class="btn btn-primary btn-sm">Open file
                                </a>
                            </div>
                        </div>
                    @endforeach
                    ...
                    @foreach (App\Models\Submission::category(2, 'id_user_pengirim') as $data)
                        <div class="card mb-3 mt-2 shadow-md">
                            ...
                            <div class="">
                                ...
                                <a href="{{ __($data->file_name) }}">{{ __($data->file_name) }}</a>
                            ...
                            <div class="card-header">
                                <div>
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="card-title">{{ $data->getUser->name }}</div>
                                            <div class="card-subtitle">{{ $data->updated_at }}</div>
                                        </div>
                                    </div>
                                </div>
