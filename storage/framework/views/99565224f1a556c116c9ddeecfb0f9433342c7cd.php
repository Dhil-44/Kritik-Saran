<div class="modal fade createUser" wire:ignore.self tabindex="-1" id="modal-lg" style="display: none;" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                ...
                <form wire:submit.prevent="createNewUser()">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:modal="role" id="roleUser" class="form-control">
                            ...
                            foreach ($__currentLoopData as $rl) : $__env->incrementLoopIndices();
