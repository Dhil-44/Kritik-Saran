...
} elseif ($_instance->childHasBeenRendered('mpyiN3n')) {
    $componentId = $_instance->getRenderedChildComponentId('mpyiN3n');
    $componentTag = $_instance->getRenderedChildComponentTagName('mpyiN3n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mpyiN3n');
} else {
    $response = \Livewire\Livewire::mount('auth.login-controller');
    $html = $response->html();
    $_instance->logRenderedChild('mpyiN3n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
