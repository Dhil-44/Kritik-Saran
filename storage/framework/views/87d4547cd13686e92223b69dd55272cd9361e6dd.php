...
} elseif ($_instance->childHasBeenRendered('xfszT7U')) {
    $componentId = $_instance->getRenderedChildComponentId('xfszT7U');
    $componentTag = $_instance->getRenderedChildComponentTagName('xfszT7U');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xfszT7U');
} else {
    $response = \Livewire\Livewire::mount('home.home-page');
    $html = $response->html();
    $_instance->logRenderedChild('xfszT7U', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('home.tampilan-utama', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Kritik-Saran\resources\views/home/content-home.blade.php ENDPATH**/ ?>