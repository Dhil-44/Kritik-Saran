...
} elseif ($_instance->childHasBeenRendered('bp2y1mg')) {
    $componentId = $_instance->getRenderedChildComponentId('bp2y1mg');
    $componentTag = $_instance->getRenderedChildComponentTagName('bp2y1mg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bp2y1mg');
} else {
    $response = \Livewire\Livewire::mount('sending-form.sending-all-message');
    $html = $response->html();
    $_instance->logRenderedChild('bp2y1mg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
