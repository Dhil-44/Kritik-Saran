                ...
                <?php $__currentLoopData = $subs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card mb-3 mt-2 shadow-md">
                        <div class="card-header">
                            ...
                            <div class="ribbon">
                                <button class="btn btn-blue btn-sm" wire:click="publish(<?php echo e($sub['id']); ?>,<?php echo e($sub); ?>)">
...
<?php /**PATH C:\Users\User\Kritik-Saran\resources\views/livewire/sending-form/pending-message.blade.php ENDPATH**/ ?>