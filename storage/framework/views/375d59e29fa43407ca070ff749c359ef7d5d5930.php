<div>
    <div class="row mr-2">
        <button wire:click="openModalFeed()" class="btn btn-success ml-auto mb-1">
    ...
    <div class="row">
        <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 col-lg-6 col-xl-4 mb-2">
                    <h5 class="card-title text-black"><?php echo e($new->title); ?></h5>
                <div class=" mb-1">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\Kritik-Saran\resources\views/livewire/admin/news-controller.blade.php ENDPATH**/ ?>