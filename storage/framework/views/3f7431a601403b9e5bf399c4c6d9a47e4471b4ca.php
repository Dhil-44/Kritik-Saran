...
} elseif ($_instance->childHasBeenRendered('6LBWTU7')) {
    $componentId = $_instance->getRenderedChildComponentId('6LBWTU7');
    $componentTag = $_instance->getRenderedChildComponentTagName('6LBWTU7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6LBWTU7');
} else {
    $response = \Livewire\Livewire::mount('home.home-feed-message');
    $html = $response->html();
    $_instance->logRenderedChild('6LBWTU7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
