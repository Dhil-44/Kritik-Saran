    ...
    <div class="wrapper ">
                ...
                <div class="container-fluid">
                    <div class="navbar-collapse" id="navbar-menu">
                        <ul class="navbar-nav pt-lg-3">
                            ...
                            <li
                                class="nav-item <?php echo e(request()->is('pending-message') ? 'active bg-dark rounded-pill' : ''); ?>">
        ...
        <header class="navbar navbar-light mt-4 d-none d-lg-flex d-print-none">
            <div class="container-xl">
                <h2 class="text-dark">Welcome, <strong><?php echo e(auth('web')->user()->name); ?></strong>
                </h2>
            </div>
        </header>
