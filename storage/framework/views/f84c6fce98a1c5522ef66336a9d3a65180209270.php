                ...
                <div class="container-fluid">
                    <div class="navbar-collapse" id="navbar-menu">
                        <ul class="navbar-nav pt-lg-3">
                            ...
                            <li class="nav-item <?php echo e(request()->is('pending-message') ? 'active bg-dark rounded-pill' : ''); ?>">
                                <a class="nav-link text-white" href="<?php echo e(route('pending-msg')); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             stroke-linecap="round" stroke-linejoin="round"><path stroke="none"
                                                                                                  d="M0 0h24v24H0z"
                                                                                                  fill="none"></path>
                                            <circle cx="12" cy="12" r="9"></circle><polyline
                                                points="12 7 12 12 15 15"></polyline>
                                            </svg>
                                    </span>
...
<?php echo $__env->make('user.home.tampilan-utama', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kritik-Saran\resources\views/user/home/profile.blade.php ENDPATH**/ ?>